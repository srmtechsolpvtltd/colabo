<div class="container-fluid side-collapse-container">
  <section class="animatedParent" style="background:#f6f6f6;">
    <div class="container">
      <div class="priceWrap">
        <div class="col-md-12 animated fadeIn slower go PrPane">
            ...
            <ul>
              <li>
                ...
                <h3>CRM Sync</h3>
                  ...
                  <p>Clip Leads From Social Platforms Intellegent Prospecting</p>
          ...
          <p>These teas are interested in scaling up their social selling strategies, account-based targeting, and use
            email outreach frequently.</p>
          <h2 class="colorBlack">Full Platform</h2>
          <p>The Full Colabo Sales Platform is for teams who want all the funtionality of our Engagement plan with
