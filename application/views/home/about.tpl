<div class="container-fluid side-collapse-container">
  <section class="whitebg">
    <div class="container">
      <div class="innerContent about_features">
        <div class="col-md-12">
          <div class="col-md-5 padnone">
            <h2 class="colorBlack">About Colabo</h2>
            <p>Colabo is a next-generation sales automation platform
              that provides increased functionality, productivity, and 
            ...
            <p>Colabo allows users to create custom messages and 
              ...
              These activities are then tracked and synced with their 
              CRM providing actionable data for managers. With 
              Colabo teams can eliminate manual tasks and embrace 
              automated workflows that lower sales costs and drive 
              growth. </p>
            <p>Colabo gives teams access to live accurate data and the 
              ability to intelligently engage with prospects through 
              modern channels.</p>
          </div>
